...
| `oa --update-force` | **Fuerza** la re-instalación y re-parcheo completo (ignora idempotencia) |
...
| `oa start` | Inicia el Gateway en segundo plano (Resiliente) |
| `oa stop` | Detiene el Gateway de fondo (Limpia procesos colgados) |
