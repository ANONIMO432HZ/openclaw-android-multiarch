...
cmd_ui() {
    ...
    echo ""
    echo -e " ${GREEN}${BOLD}STEP 1: RUN THIS ON YOUR COMPUTER (Powershell)${NC}"
    echo -e " ${DIM}The original command is incomplete. Use this instead:${NC}"
    echo ""
